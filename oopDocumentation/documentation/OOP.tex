...
\begin{document}
	...
	assigns trams to lines, begins the simulation, stores data from all objects. To make sure there is only one instance of this, it implements singleton design pattern. Inside Traffic Manager there is CSV Manager class that reads input data from CSV file and writes output after simulation ends.
	...
	\includegraphics[scale = 0.30]{objDiagram.png}\\[2cm]
