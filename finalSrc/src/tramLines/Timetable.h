...
private:
    ...
    shared_ptr<TramStop> StadionLotnicza, Kwiska, PlacJanaPawla, FAT, PlacLegionow, Hallera, ArkadyCapitol, ArkadyCapitol_2, DworzecGlowny, Swidnicka, Krakowska, KsiezeMale,
        GaleriaDominikanska, PlacBema, PlacWroblewskiego, PlacGrunwaldzki, Kochanowskiego, Sepolno, Zoo, Biskupin, Bardzka, Tarnogaj, Gaj, DworzecAutobusowy, Kromera;
